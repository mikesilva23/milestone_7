...
For my extension, I decided to look at missing data in the data sets and impute data for the regressions used in table 3.  Looking at the tables below, I was able to 
...
[^1]: [(https://github.com/cpatvakanian/milestone_7)] 
